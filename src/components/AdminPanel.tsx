...
import { UserBackupModal } from './UserBackupModal';
...
export const AdminPanel: React.FC<AdminPanelProps> = ({
  ...
  const [isUserBackupModalOpen, setIsUserBackupModalOpen] = useState(false);
  ...
  return (
    <div className="flex-1 flex h-screen bg-slate-100 absolute inset-0 z-50 overflow-hidden">
          ...
          <div className="p-4 sm:p-5 border-b border-slate-800 flex justify-between items-center bg-slate-950/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] text-blue-400 font-medium">Pusat Kontrol & Pengawasan</p>
              </div>
            </div>
            <button
          ...
          <div className="p-4 space-y-6">
            <div>
              <p className="px-3 mb-2.5 text-[10px] font-bold uppercase tracking-wider text-slate-400">
                Menu Utama Portal Ujian
              </p>
              <nav className="space-y-1.5">
                {/* 1. UPLOAD & KELOLA PAKET SOAL */}
                <button
                  onClick={() => {
                    setActiveTab('bank');
                ...
                >
                  ...
                  >
                    {displayStudentsList.length} Siswa
                  </span>
                </button>

                {/* 3. TOKEN & JADWAL UJIAN */}
                <button
                  onClick={() => {
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span>Download Hasil Ujian</span>
                  </div>
                  {studentResults.length > 0 && (
                    <span
                      className={`px-2 py-0.5 rounded-full text-[10px] font-black ${
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="font-bold text-slate-800 text-sm sm:text-base flex items-center gap-2 truncate">
                ...
                <span>
                  {activeTab === 'panduan' && 'Panduan Alur Kerja Proktor — Portal Ujian CBT'}
                  {activeTab === 'mapel' && 'Pengaturan Mata Pelajaran & Header Ujian'}
                  {activeTab === 'bank' && 'Paket Soal Ujian (Siap Uji)'}
                  {activeTab === 'students' && 'Data Peserta Ujian & Presensi'}
              ...
              <p className="text-[11px] text-slate-500 hidden sm:block truncate">
                Portal Ujian CBT — Pusat Kontrol & Pengawasan Ujian
              </p>
            </div>
          </div>
            ...
            <div className="p-4 sm:p-6 max-w-5xl mx-auto w-full space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-xs hover:shadow-md transition-all space-y-3">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-slate-100">
                    <div className="flex items-center gap-3">
                      ...
                      <h4 className="font-extrabold text-slate-800 text-sm flex items-center gap-2">
                        ...
                        Pemeriksaan Paket Soal Ujian (Siap Uji)
                      </h4>
                    </div>
                    <button
                  ...
                  <div className="text-xs text-slate-600 space-y-2 leading-relaxed">
                    <p className="font-semibold text-slate-800">
                      Aplikasi ini beroperasi sebagai <strong>Portal Ujian CBT</strong> (bukan aplikasi input soal manual di ruang ujian). Butir soal disajikan dari paket ujian terverifikasi:
                    </p>
                    <ol className="list-decimal list-inside space-y-1 pl-1 text-slate-700">
                      <li>Masuk ke menu <strong className="text-blue-700">Paket Soal Ujian</strong>.</li>
                      <li>Periksa butir pertanyaan, pilihan jawaban, stimulus soal, gambar, dan kunci jawaban melalui tombol <strong>Preview</strong>.</li>
                      <li>Pastikan seluruh butir soal yang diujikan bertanda status <strong className="text-emerald-600">Aktif</strong>. Anda dapat menonaktifkan butir tertentu jika terjadi pembatalan soal.</li>
                      <li>Jika panitia ujian memberikan file paket soal baru, Anda dapat memuatnya melalui tombol <strong>Muat Paket Soal (.json)</strong> atau sinkronisasi <strong>Google Sheets</strong>.</li>
                      <li>Anda juga dapat mengunduh naskah soal dalam format <strong>PDF / MS Word</strong> untuk dokumentasi arsip ujian.</li>
                    </ol>
                  </div>
                </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 border-b border-gray-100 pb-4 gap-4">
              <div>
                <h2 className="font-bold text-xl text-gray-800 flex items-center gap-2">
                  <Database className="w-6 h-6 text-blue-600" /> Paket Soal Ujian (
                  <span className="text-blue-600 font-black">{config.questions.length} Butir</span>)
                </h2>
                <p className="text-xs text-slate-500 mt-1">
                  Soal Aktif Diujikan: <b className="text-emerald-600">{config.questions.filter((q) => q.isActive !== false).length}</b> dari {config.questions.length} Butir Soal Siap Uji
                </p>
              </div>
              ...
              <div className="flex gap-2 flex-wrap">
                <button
                  ...
                  title="Muat atau Simpan File Paket Soal Ujian (.json)"
                >
                  <FileJson className="w-4 h-4" /> Muat Paket Soal (.json)
                </button>
                ...
                <button
                  ...
                  title="Sinkronisasi Paket Soal dari Google Sheets"
                >
                ...
                <button
                  ...
                  title="Export Naskah Soal ke PDF atau MS Word"
                >
                ...
                <button
                  onClick={handleExportActivePaketJson}
                  className="bg-slate-800 hover:bg-slate-900 text-white px-3.5 py-2 rounded-xl font-bold text-xs shadow-sm transition-all flex items-center gap-1.5 active:scale-95 cursor-pointer"
                  title="Unduh Cadangan File Paket Soal (.json)"
                >
                  <Download className="w-4 h-4" /> Cadangkan Paket (.json)
                </button>
              </div>
            </div>

            {/* Banner Mode Portal Ujian */}
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-3.5 mb-4 text-xs text-blue-900 flex items-start gap-3">
              <span className="p-2 rounded-xl bg-blue-200/80 text-blue-800 shrink-0 mt-0.5">
                <Info className="w-4 h-4" />
              </span>
              <div className="space-y-1">
                <p className="font-bold text-blue-950">
                  Mode Portal Ujian Aktif (Asesmen & Pelaksanaan Ujian)
                </p>
                <p className="text-blue-800 text-[11px] leading-relaxed">
                  Aplikasi difokuskan sebagai <strong>Portal Ujian CBT</strong> untuk melayani pengerjaan siswa dan pengawasan proktor. Butir soal disajikan langsung dari paket ujian terverifikasi. Anda dapat mempratinjau butir soal, mengaktifkan/menonaktifkan butir soal yang diujikan, atau memuat paket soal baru (.json / Spreadsheet) jika ada pembaruan naskah dari panitia.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 mb-4 flex flex-wrap items-center justify-between gap-3 text-xs">
              ...
              {selectedQuestionIds.length > 0 && (
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  >
                    <XCircle className="w-3.5 h-3.5" /> Nonaktifkan Terpilih
                  </button>
                </div>
              )}
            </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-3 pr-1 custom-scrollbar">
              {filteredQuestions.length === 0 ? (
                <div className="text-center text-gray-400 py-12 text-sm font-medium">
                  Belum ada butir soal yang sesuai dengan filter. Silakan ubah filter atau muat paket soal (.json / Google Sheets).
                </div>
              ) : (
                    ...
                    >
                      ...
                      <div className="flex gap-2 shrink-0 w-full sm:w-auto mt-2 sm:mt-0 pl-8 sm:pl-0">
                        <button
                          ...
                          className="flex-1 sm:flex-none bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 px-3 py-2 rounded-lg text-xs font-bold transition-all shadow-xs flex items-center justify-center gap-1.5 active:scale-95 cursor-pointer"
                          title="Export butir soal ini ke PDF atau Word"
                        >
                        ...
                        <button
                          ...
                          title="Pratinjau tampilan soal pada portal ujian siswa"
                        >
            ...
            <>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  <button
                    onClick={() => setIsUserBackupModalOpen(true)}
                  ...
                  >
                    <Database className="w-4 h-4 text-emerald-200" /> Backup Master User
                  </button>
      ...
      {/* MODAL: BACKUP CLOUD MASTER DATA USER */}
      <UserBackupModal
        isOpen={isUserBackupModalOpen}
        onClose={() => setIsUserBackupModalOpen(false)}
        students={displayStudentsList}
        teachers={teachersList}
        admins={adminsList}
        showAlert={showAlert}
